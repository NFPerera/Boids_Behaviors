...
{
    [CreateAssetMenu(fileName = "ObstacleAvoidanceState3D", menuName = "main/SteeringsBh/3D/ObstacleAvoidanceState3D", order = 0)]
    public class ObstacleAvoidanceState3D: SteeringDataState
    {
